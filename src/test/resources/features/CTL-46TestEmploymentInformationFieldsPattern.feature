@CTeckLoan-46
Feature: Test Contact Information fields pattern(field max and min length) 
Background: 
...
Scenario Outline: 
	...
	Examples: 
		...
		|123           |Apt 203       |Fairfax|VA   |20120   |United States|2023455566|2023333456|22222|mark@gmail.com|mark@cybertek.com|
	...
	Examples: 
		|Street Address|Address Line 2|City            |State|Zip Code|Country      |PPNumber  |WPNumber  |Ext. |PEmail        |WEmail           |
		|123           |Apt 203       |Fairfaxxxxxxxxxx|VA   |20120   |United States|2023455566|2023333456|22222|mark@gmail.com|mark@cybertek.com|
