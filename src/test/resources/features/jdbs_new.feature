...
Scenario Outline: User will enter personal information 
	...
	|	Maroune | Knowlegdaq 		| Gaassd 	| M 		| 12/23/1980 	| 876567439 |
...
Scenario Outline: User will enter financial information 
   ...
   Scenario: User submits application then verify personal information in DataBase
   Given as User gets loan application ID
   And User should have personal information in DataBase
